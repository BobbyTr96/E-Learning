...
const UserInformation = lazy(() => import("../modules/Auth/UserInfomation/UserInformation"));
const CourseCatalog = lazy(() => import("../modules/CourseCatalog/CourseCatalog"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/thongTinNguoiDung", element: <UserInformation /> },
      // Course Catalog
